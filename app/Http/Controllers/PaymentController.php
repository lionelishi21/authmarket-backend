...
class PaymentController extends Controller {
    ...
    public function payWithpaypal(Request $request){
        ...
        try {$payment->create($this->_api_context);} catch (\PayPal\Exception\PPConnectionException $ex) {if 

        (\Config::get('app.debug')) {\Session::put('error', 'Connection timeout');
